...
.PHONY: proto
proto:
	protoc --proto_path=./third_party --proto_path=./api --go_out=paths=source_relative:./api --go-grpc_out=paths=source_relative:./api --go-http_out=paths=source_relative:./api ./api/server/api.proto