...
// The ConfirmFunc type is an adapter to allow the use of ordinary
// function as Confirm mutator.
type ConfirmFunc func(context.Context, *ent.ConfirmMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ConfirmFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ConfirmMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ConfirmMutation", m)
}
