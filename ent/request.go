...
type Request struct {
	...
	// nonce of token transfer
	Nonce int64 `json:"nonce,omitempty"`
	// whether the request has been executed successfully
...
func (r *Request) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", r.Nonce))
	builder.WriteString(", ")
	builder.WriteString("executed=")
	builder.WriteString(fmt.Sprintf("%v", r.Executed))
	builder.WriteByte(')')
